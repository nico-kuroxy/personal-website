...
export default function Header(props) {
    ...
    return (
        ...
        <nav className="fixed top-0 z-40 w-full flex flex-row justify-between bg-gradient-to-b from-[#1314EC] to-[#00b9ff] text-white text-2xl px-3 py-5 rounded-b-2xl"> 
