     ...
     return (
        ...
        <div className="flex pt-2 font-bold text-center dark:text-white text-blue-900 font-monoCustom text-xl justify-center items-center">
            ...
            <a href="mailto:nicolas.erbetti.k@gmail.com">
                <span className="flex active:[text-shadow:0_0_5px_#ff073a] dark:bg-yellow-500 dark:hover:bg-yellow-300 dark:active:bg-yellow-300 bg-yellow-300 hover:bg-yellow-500 active:bg-yellow-500 p-2 ml-2 m-2">Contact me</span>
            </a>
            {/* Download the resume. */}
            <a href="/resume/cv_nicolas_erbetti_en.pdf" download>
                <span className="flex items-center justify-center active:[text-shadow:0_0_5px_#ff073a] dark:bg-yellow-500 dark:hover:bg-yellow-300 dark:active:bg-yellow-300 bg-yellow-300 hover:bg-yellow-500 active:bg-yellow-500 p-2 ml-2 m-2">Download CV</span>
            </a>
